...
export class Convert {
    public static toSearchPersonResponse(json: string): SearchPersonResponse {
        return cast(JSON.parse(json), r("SearchPersonResponse"));
    }

    public static searchPersonResponseToJson(value: SearchPersonResponse): string {
        return JSON.stringify(uncast(value, r("SearchPersonResponse")), null, 2);
    }
}
